...
banca_java/ │ ├── src/ │ ├── App.java # Classe principale (main) │ ├── Conto.java # Gestione del conto corrente │ └── utente.java # Definizione dell’utente │ ├── bin/ # File compilati (.class) │ └── README.md # Descrizione del progetto

⚙️ Come eseguire il progetto
Compila i file Java:
javac src/*.java -d bin

👥 Classi principali Utente

Rappresenta un cliente della banca. Contiene informazioni come nome, cognome e ID utente.
...
Questo progetto è distribuito con licenza MIT. Puoi modificarlo e riutilizzarlo liberamente, citando l’autore originale.

✍️ Autore

Biagio Boccardi Progetto Java – Banca JV 📅 2025
